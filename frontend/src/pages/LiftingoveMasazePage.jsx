...
function LiftingoveMasazePage() {
  ...
  useEffect(() => {
    const loadCategories = async () => {
      try {
        setLoading(true);
        setError(null);
        const categoriesData = await fetchCategories("liftingove-masaze");
  ...
  return (
    <div className="portfolio-page">
      <h1 className="portfolio-title">Liftingové masáže</h1>
...
export default LiftingoveMasazePage;
